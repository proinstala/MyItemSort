<%-- 
    Document   : localidadList
    Created on : 3 abr 2025, 18:29:31
    Author     : judas
--%>
        ...
        <div class="main">
            ...
            <div class="contenedor__formulario formulario--4_filas max-width-120" id="form_busqueda">
                ...
                <div class="contenedor__formulario--main">
                    <form class="formulario" name="frmBuscarLocalidad" id="frmBuscarLocalidad">
                ...
                <div class="contenedor__tabla--botones">
                    ...
                    <div class="form__btn_circle">
                        <button form="frmBuscarLocalidad" id="btnBuscar" title="Buscar" type="submit"><i class="las la-search"></i></button>
                    </div>
                    <div class="form__btn_circle">
                ...
                <div class="contenedor__tabla">
                    <table class="tabla" id="tablaLocalidades" data-rowselected = "-1">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombre</th>
