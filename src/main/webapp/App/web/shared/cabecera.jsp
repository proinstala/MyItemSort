...
<div class="cabecera">
    <div class="contenedor__inicio" title="Configuración">
        ...
        -->
        <svg id="btnConfig<%= extraAdmin %>" class="contenedor__inicio--config" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="contenedor__menu">
        <i class="las la-warehouse" title="Almacén" id="btnAlmacen"></i>
        <i class="las la-icons" title="Artículo" id="btnArticulo"></i>
